...
- [`foundation/shared-continuity-foundation.md`](foundation/shared-continuity-foundation.md) — approved conceptual Shared Continuity Foundation responsibility definition; documentation-only, not shared implementation approval.
- [`foundation/shared-continuity-foundation-disposition-record.md`](foundation/shared-continuity-foundation-disposition-record.md) — disposition table for approved, deferred, application-specific, configuration-specific, and delivery-infrastructure capabilities.
- [`foundation/candidate-shared-continuity-foundation.md`](foundation/candidate-shared-continuity-foundation.md) — candidate foundation evidence record retained as validation input; superseded by the approved foundation where they differ.
...
| What Shared Continuity Foundation responsibilities are approved? | [`foundation/shared-continuity-foundation.md`](foundation/shared-continuity-foundation.md) |
| How were candidate shared capabilities dispositioned? | [`foundation/shared-continuity-foundation-disposition-record.md`](foundation/shared-continuity-foundation-disposition-record.md) |
