...
## Primary User
Home health Occupational Therapists and Occupational Therapy Assistants managing medically complex adult patients in real residential environments.
...
The deterministic reasoning engine serves as the authoritative clinical structure.
...
### 1. Operational Clarity Over Information Volume
The system should reduce cognitive burden, not increase it.

---

### 2. Explainability Over AI Novelty
Reasoning should remain clinically defensible and understandable.

---

### 3. Environmental Realism Over Generic Recommendations
Recommendations must reflect real residential environments and practical feasibility.

---

### 4. Workflow Speed Over Narrative Complexity
Outputs should improve rapid clinician orientation and visit execution.

---

### 5. Constraint-Aware Reasoning Over Idealized Planning
Caregiver limitations, environmental barriers, safety risks, and real-world feasibility must shape recommendations.
